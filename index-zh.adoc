...
:title-zh: SM2密码算法使用规范
:title-en: SM2 cryptography algorithm application specification
:gb-standard-type: industry
:gb-standard-series: GM
:gb-standard-mandate: recommended
:gb-standard-code: 0009
:gb-standard-edition: 2012
:gb-standard-published: 2012-11-22
:gb-standard-active: 2012-11-22
...
:gb-standard-technical-committee-zh: 全国信息安全标准计算委员会（SAC/TC260）
:gb-standard-technical-committee-en: National Information Security Standardization Technical Committee (SAC/TC260)
:stem:
...
本标准由{gb-standard-technical-committee-zh}归口。
...
////
* GM/T 0003 (all parts) SM2 Elliptic Curve Cryptography Public Key Algorithm
